...
public class LessonDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPagerTabStrip.setTabIndicatorColor(Color.CYAN);
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if(Timetable.mPeriodType==0) {
                switch (position) {
                    case 0:
                        return LessonDetailFragment.newInstance(0);
                    case 1:
                        return FreePeriodFragment.newInstance(0);
                    default:
                        return PlaceholderFragment.newInstance(position + 1);
                }
            }
            else if(Timetable.mPeriodType==1){
                switch (position) {
                    case 0:
